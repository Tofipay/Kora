...
استُبدلت جميع أشكال الاسم القديم (Qamhad Live / Qamhad / قمهد / قمهد لايف / Gamhed / Gamhed Sport) بـ **ToFi X Tv / توفي إكس تيفي** في:
...
- الدومين الافتراضي للسياقات بدون طلب (CLI/Cron): `https://tofi-xtv.com`، ويمكن تثبيته عبر `TOFIXTV_SITE_URL`.
