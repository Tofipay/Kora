<?php
/**
 * ALOKA Live — notification worker (run from cron every minute):
 ...
 *   wget -q -O /dev/null "https://aloka-code.shop/cron/notify?key=THE_KEY"
 * (the key is shown in Admin → Notifications). Both paths run the same scan.
 */
declare(strict_types=1);

$_SERVER['HTTP_HOST'] = $_SERVER['HTTP_HOST'] ?? 'aloka-code.shop';
