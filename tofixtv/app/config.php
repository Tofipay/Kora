...
/* ---------- Brand ---------- */
define('SITE_NAME_AR',  'ALOKA Live');
define('SITE_NAME_EN',  'ALOKA Live');
...
define('SITE_EMAIL',    'https://t.me/alokalive');

/* ALOKA Live identity palette */
define('BRAND_PRIMARY', '#1B0761');   // deep purple
define('BRAND_SECONDARY', '#4C0ECD'); // bright purple
define('BRAND_DARK',    '#10033D');
define('BRAND_ACCENT',  '#4C0ECD');
...
define('DEFAULT_DOMAIN', 'https://aloka-code.shop');
...
define('PRIMARY_HOST', (string)(parse_url(SITE_URL, PHP_URL_HOST) ?: 'aloka-code.shop'));
...
define('ADMIN_DEFAULT_PASSWORD', 'aloka-admin-2026'); // change on first login (stored hashed)
