...
<?php if ($isAr): ?>
  ...
  <div class="legal-body">
    ...
    <h2>تواصل معنا</h2>
    <p>نرحب دائماً بملاحظاتكم واقتراحاتكم عبر صفحة <a href="<?= e(path('contact')) ?>">اتصل بنا</a>، أو مباشرة على <a href="<?= e(SITE_EMAIL) ?>" target="_blank" rel="noopener">@alokalive</a>.</p>
  </div>
<?php else: ?>
  ...
  <div class="legal-body">
    ...
    <h2>Get in touch</h2>
    <p>We always welcome your feedback and suggestions via the <a href="<?= e(path('contact')) ?>">contact page</a> or directly at <a href="<?= e(SITE_EMAIL) ?>" target="_blank" rel="noopener">@alokalive</a>.</p>
  </div>
<?php endif; ?>
</div>
</div>
