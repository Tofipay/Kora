...
<section class="section container reveal">
  ...
  <div class="hscroll live-slider">
    ...
    <a class="live-card glass" href="<?= e(match_url($m)) ?>" data-match="<?= (int)$m['match_id'] ?>">
      ...
      <div class="lc-row">
        <span class="lc-team"><img src="<?= e(team_img($home)) ?>" alt="" width="28" height="28" loading="lazy"><span title="<?= e(team_name($home)) ?>"><?= e(team_name($home)) ?></span></span>
        <span class="lc-score" data-hs><?= (int)($m['home_scores'] ?? 0) ?></span>
      </div>
      <div class="lc-row">
        <span class="lc-team"><img src="<?= e(team_img($away)) ?>" alt="" width="28" height="28" loading="lazy"><span title="<?= e(team_name($away)) ?>"><?= e(team_name($away)) ?></span></span>
...
<section class="section container reveal">
  ...
  <div class="featured-grid">
    ...
    <a class="featured-card glass card-hover" href="<?= e(match_url($m)) ?>" data-match="<?= (int)$m['match_id'] ?>">
      ...
      <div class="fc-teams">
        <span class="fc-team"><img src="<?= e(team_img($home, '128')) ?>" alt="<?= e(team_name($home)) ?>" width="52" height="52" loading="lazy"><b title="<?= e(team_name($home)) ?>"><?= e(team_name($home)) ?></b></span>
        <span class="fc-mid">
          <?php if ($st['started']): ?>
        ...
        <span class="fc-team"><img src="<?= e(team_img($away, '128')) ?>" alt="<?= e(team_name($away)) ?>" width="52" height="52" loading="lazy"><b title="<?= e(team_name($away)) ?>"><?= e(team_name($away)) ?></b></span>
      </div>
    </a>
    <?php endforeach; ?>
  </div>
...
<?php elseif ($sectionId === 'movies' && !empty($movies)): ?>
...
<?php elseif ($sectionId === 'series' && !empty($seriesRow)): ?>
<?= View::partial('poster-row', [
    'title'   => t('nav.series'),
    'items'   => $seriesRow,
    'type'    => 'tv',
...
<?php elseif ($sectionId === 'trending' && (!empty($trendingAll) || !empty($newContent))): ?>
