...
$sections = [
    ...
    ['M3 6h18v12H3zM8 6v12M16 6v12M9 3l3 3 3-3',                      t('nav.channels'),  path('channels'),    false],
...
<div class="container more-page">
  ...
  <section class="more-group glass-soft">
    ...
    <a class="mg-row mg-link" href="https://t.me/alokalive" target="_blank" rel="noopener">
      <span class="mg-ic" aria-hidden="true">
      ...
      <span class="mg-label"><?= e(t('more.telegram')) ?><small>@alokalive</small></span>
      <svg class="mg-arrow" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="<?= $arrow ?>"/></svg>
    </a>
  ...
  <section class="more-group glass-soft">
    ...
    <a class="mg-row mg-link" href="https://t.me/alokalive" target="_blank" rel="noopener nofollow">
      <span class="mg-ic" aria-hidden="true">
