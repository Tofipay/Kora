...
@media(max-width:860px){
  ...
  .admin-topbar{position:sticky;top:0;z-index:40;display:flex;align-items:center;gap:12px;
    padding:12px 16px;background:rgba(8,14,26,.85);-webkit-backdrop-filter:blur(16px);backdrop-filter:blur(16px);
  ...
  aside{position:fixed;inset-block:0;inset-inline-start:0;width:min(300px,84vw);height:100dvh;z-index:60;
    ...
    background:rgba(10,17,31,.97);border-inline-end:1px solid var(--line);box-shadow:var(--shadow)}
  ...
  .drawer-overlay{display:block;position:fixed;inset:0;z-index:50;background:rgba(2,6,14,.6);
...
<header class="admin-topbar">
  ...
  <span class="dot" style="width:30px;height:30px;border-radius:9px;display:grid;place-items:center;background:linear-gradient(135deg,var(--p),var(--p2));color:#06281b">
