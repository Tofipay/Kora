...
<div class="card">
  <form method="post">
    ...
    <div class="row">
      <div><label>Home title (Arabic)</label><input type="text" name="title_ar" value="<?= e($s['title_ar'] ?? '') ?>" placeholder="ALOKA Live — نتائج مباشرة…"></div>
      <div><label>Home title (English)</label><input type="text" name="title_en" value="<?= e($s['title_en'] ?? '') ?>" placeholder="ALOKA Live — Live scores…"></div>
    </div>
...
<div class="card">
  ...
  <ul style="color:#9FB0C8;font-size:13px;margin:8px 0 0;padding-left:18px">
    ...
    <li><a href="/sitemap.xml" target="_blank" style="color:#4C0ECD">/sitemap.xml</a> + <a href="/sitemap-news.xml" target="_blank" style="color:#4C0ECD">/sitemap-news.xml</a> + robots.txt</li>
