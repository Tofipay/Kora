...
<div class="stat-grid">
  ...
  <div class="stat"><span class="lbl">مشاهدات اليوم</span><b><?= $fmt($today) ?></b></div>
  <div class="stat"><span class="lbl">زوار فريدون اليوم</span><b><?= $fmt($uvToday ?? 0) ?></b></div>
  ...
  <div class="stat"><span class="lbl">إجمالي المشاهدات</span><b><?= $fmt($total) ?></b></div>
...
<!-- 14-day traffic (views + unique visitors) -->
<div class="card">
  <b>الزيارات — آخر ١٤ يومًا</b>
  <?php $max = 1; foreach ($days as $d) $max = max($max, (int)($d['total'] ?? 0)); ?>
  <div class="bar">
    <?php foreach ($days as $day => $d): ?>
      <div style="height:<?= max(4, round(((int)($d['total'] ?? 0)) / $max * 100)) ?>%" title="<?= e($day) ?>: <?= (int)($d['total'] ?? 0) ?> مشاهدة · <?= (int)($d['uv'] ?? 0) ?> زائر"><span><?= e(substr($day, 5)) ?></span></div>
    <?php endforeach; ?>
  </div>
...
<div class="cols c2">
  ...
  <div class="card"><b>أهم الدول</b><?php $metric($countries ?? []); ?></div>
</div>
<div class="cols c2">
...
<div class="cols c2">
  <div class="card"><b>أكثر الصفحات زيارة</b><?php $ranked($topPages ?? []); ?></div>
