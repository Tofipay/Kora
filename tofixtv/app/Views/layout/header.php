...
<header class="site-header glass">
  <div class="container header-inner">
    ...
    <nav class="main-nav" aria-label="main">
      ...
      <a class="nav-link<?= $isActive('/channels') ?>" href="<?= e(path('channels')) ?>"><?= e(t('nav.channels')) ?></a>
      <a class="nav-link<?= $isActive('/movies') ?: $isActive('/movie') ?>" href="<?= e(path('movies')) ?>"><?= e(t('nav.movies')) ?></a>
      <a class="nav-link<?= $isActive('/series') ?>" href="<?= e(path('series')) ?>"><?= e(t('nav.series')) ?></a>
    ...
    <div class="header-actions">
      ...
      <a class="icon-btn mob-hide" href="<?= e(path('favorites')) ?>" aria-label="<?= e(t('nav.favorites')) ?>">
      ...
      <button class="icon-btn mob-hide" id="theme-toggle" aria-label="<?= e(t('misc.theme')) ?>">
      ...
      <a class="lang-switch mob-hide" href="<?= e($altPath) ?>" rel="alternate" hreflang="<?= Lang::current() === 'ar' ? 'en' : 'ar' ?>">
