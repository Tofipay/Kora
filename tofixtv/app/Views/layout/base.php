...
$isAr = Lang::isRtl();
?><!DOCTYPE html>
<html lang="<?= Lang::current() ?>" dir="<?= Lang::dir() ?>" class="dark" data-theme="<?= e($theme['default_mode'] ?? 'dark') ?>" style="background-color:#1b0761;color-scheme:dark">
<head>
<meta charset="UTF-8">
...
(function(){try{
  ...
  r.style.backgroundColor=d?'#1b0761':'#ffffff';
...
<?php require APP_DIR . '/Views/layout/app-required-dialog.php'; ?>
...
window.ALOKA.ai = {
  ...
  error:'<?= e(t('ai.error')) ?>', rate_limited:'<?= e(t('ai.rate_limited')) ?>', thinking:'<?= e(t('ai.thinking')) ?>',
