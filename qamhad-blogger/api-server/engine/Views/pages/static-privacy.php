<?php use Qamhad\Core\Lang; $isAr = Lang::current() === 'ar'; ?>
...
<?php if ($isAr): ?>
  ...
  <div class="legal-body">
    ...
    <h2>التواصل معنا</h2>
    <p>لأي استفسار يتعلق بالخصوصية أو لطلب حذف بياناتك، راسلنا عبر صفحة <a href="<?= e(path('contact')) ?>">اتصل بنا</a> أو مباشرة على <a href="mailto:<?= e(SITE_EMAIL) ?>"><?= e(SITE_EMAIL) ?></a>.</p>
  </div>
...
<?php else: ?>
  ...
  <div class="legal-body">
    ...
    <h2>Contact us</h2>
    <p>For any privacy question or data deletion request, reach us via the <a href="<?= e(path('contact')) ?>">contact page</a> or directly at <a href="mailto:<?= e(SITE_EMAIL) ?>"><?= e(SITE_EMAIL) ?></a>.</p>
  </div>
