...
<?php if ($isAr): ?>
  ...
  <div class="legal-body">
    ...
    <h2>10. التواصل</h2>
    <p>لأي استفسار حول هذه الشروط يمكنك مراسلتنا عبر صفحة <a href="<?= e(path('contact')) ?>">اتصل بنا</a> أو على البريد <a href="mailto:<?= e(SITE_EMAIL) ?>"><?= e(SITE_EMAIL) ?></a>.</p>
  </div>
...
<?php else: ?>
  ...
  <div class="legal-body">
    ...
    <h2>10. Contact</h2>
    <p>For any question about these terms, reach us via the <a href="<?= e(path('contact')) ?>">contact page</a> or at <a href="mailto:<?= e(SITE_EMAIL) ?>"><?= e(SITE_EMAIL) ?></a>.</p>
  </div>
