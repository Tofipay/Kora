...
# قمهد لايف — Qamhad Live

منصة كرة قدم عربية/إنجليزية متكاملة بهوية 2026: نتائج مباشرة، مركز مباريات تفصيلي، ترتيب، هدافون، أخبار، PWA وإشعارات — بدون قاعدة بيانات وبدون أي إطار عمل خارجي.

</div>

**Qamhad Live** is a bilingual (Arabic-first) football platform: live scores,
a full match center, standings, top scorers, news, PWA and push notifications —
