...
<meta name="robots" content="noindex,nofollow"><title>Login · Qamhad Live Admin</title>
...
h1 i{width:12px;height:12px;border-radius:4px;background:#16C784}
...
button{width:100%;margin-top:14px;background:#16C784;border:0;color:#06281b;font-weight:800;padding:11px;border-radius:999px;cursor:pointer;font:inherit}
