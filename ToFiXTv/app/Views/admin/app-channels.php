...
<div class="card">
  ...
  <p class="hint" style="margin:6px 0 0">
    قسم مستقل خاص بالتطبيق فقط (الهيدر <code dir="ltr">apptofi: com.tofixtv.app</code>) — لا يؤثر على مكتبة قنوات الموقع.
    لكل قناة: <b>اسم القناة</b> و<b>روابط المشاهدة</b>. القيمة قد تكون رابطاً عادياً
    <b>أو نصاً/توكن مشفّراً</b> — تُحفظ كما أُدخلت تماماً بدون فلترة. يمكن إضافة أكثر من قيمة،
    ويُفضّل وضع كل قيمة في <b>سطر مستقل</b> (أو مفصولة بفاصلة بين الروابط).<br>
    ...
    وعند التطابق تُستخدم قيم القناة في زر التطبيق الأزرق — حتى لو لم يُضف رابط مباشر للمباراة.
  </p>
</div>
