...
.app-day.on{background:rgba(22,199,132,.14);border-color:rgba(22,199,132,.45);color:var(--p)}
.app-badge{display:inline-block;padding:3px 10px;border-radius:999px;font-size:11.5px;font-weight:800;white-space:nowrap}
.app-badge.ok{background:rgba(37,99,235,.18);color:#93c5fd}
.app-badge.auto{background:rgba(22,199,132,.15);color:var(--p)}
