...
final class MatchCenter
{
    public static function show(string $slug): void
    {
        ...
        // link (direct per-match link, else the app channel library). Purely
        // additive: '' / false for every normal visitor.
        $isApp = is_tofix_app();
        $appWatchUrl = $isApp ? \TofiXTv\Core\AppLinks::resolveForMatch($id) : '';
        // The HTML differs for the app UA, so caches must key on it.
