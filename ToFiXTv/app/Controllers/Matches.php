...
final class Matches
{
    ...
    public static function day(string $day): void
    {
        ...
        $seo = (new Seo())
            ...
            ->description(t('matches.title') . ' ' . format_date_long($date) . ' — ' . \TofiXTv\Core\Lang::siteName())
            ->breadcrumbs([
                [t('nav.home'), path('/')],
        ...
        if ($matches) {
            $listName = \TofiXTv\Core\Lang::current() === 'ar'
    ...
    public static function live(): void
    {
        ...
        $seo = (new Seo())
            ->title(t('home.live'))
            ->description(t('home.live') . ' — ' . \TofiXTv\Core\Lang::siteName())
            ->breadcrumbs([
                [t('nav.home'), path('/')],
